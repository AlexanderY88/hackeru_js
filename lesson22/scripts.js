...
// will not work because the js file is module, so need use another way
...
// to resolve the problem with module, just assign the function to the window object like: 
window.addNewAction = () => {
  clearTable();
